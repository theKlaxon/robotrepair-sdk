...
function OnAtlasRepairButtonTriggerTouched( self, args )
	...
	--Turn off teleport
	EntFireByHandle( self, EntHandles.ServerCommands.Command.Ent, "Command", "vr_multitool_trackpad_teleport_invalid 1", 0 )
...
function OnAtlasCollapseTriggerTouched( self, args )
	...
	--Turn on teleport after around 23 seconds
	EntFireByHandle( self, EntHandles.ServerCommands.Command.Ent, "Command", "vr_multitool_trackpad_teleport_invalid 0", 23 )
