...
void * __cdecl __calloc_base( size_t nSize )
{
...
void *__recalloc_base( void *pMem, size_t nSize )
{
...
{
	return __calloc_base( count * size );
}
...
{
	return __recalloc_base( ptr, size * count );
}
